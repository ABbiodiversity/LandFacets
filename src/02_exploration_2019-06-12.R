...
multiplot(plot.list$Blowout, plot.list$RapidDrain, plot.list$ClayLoamSand, plot.list$Other, plot.list$ThinBreak, plot.list$Water, 
          plot.list$HWater, plot.list$Crop, plot.list$RoughP, plot.list$TameP, plot.list$UrbInd, plot.list$Rural, 
          plot.list$HardLin, plot.list$TrSoftLin, plot.list$EnSoftLin, plot.list$EnSeismic, plot.list$Wellsites, plot.list$Cool_slopes, 
          plot.list$Dry, plot.list$Mesic, plot.list$Sloped_mesic, plot.list$Sloped_wet, plot.list$Warm_slopes, plot.list$Wet,
      cols = 4)
